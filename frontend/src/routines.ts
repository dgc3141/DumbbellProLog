...
export const DEFAULT_TIMED_MENUS: TimedMenu[] = [
    // Push 15分
    {
        ...
        totalRestSeconds: 240,
        exercises: [
            { exerciseName: 'インクライン・プレス', sets: 3, reps: 12, recommendedWeight: 20, restSeconds: 60, notes: '肩甲骨を寄せる' },
            { exerciseName: 'ショルダー・プレス', sets: 2, reps: 12, recommendedWeight: 14, restSeconds: 60, notes: '耳の横まで下ろす' },
        ]
    },
    // Push 30分
    {
        bodyPart: 'push', durationMinutes: 30, generatedAt: '',
        totalRestSeconds: 495,
        exercises: [
    ...
    // Pull 15分
    {
        ...
        totalRestSeconds: 240,
        exercises: [
            { exerciseName: 'ワンアーム・ロウ', sets: 3, reps: 12, recommendedWeight: 18, restSeconds: 60, notes: '広背筋を意識' },
            { exerciseName: 'ハンマー・カール', sets: 2, reps: 12, recommendedWeight: 10, restSeconds: 60, notes: '前腕を固定' },
        ]
    },
    // Pull 30分
    {
        bodyPart: 'pull', durationMinutes: 30, generatedAt: '',
        totalRestSeconds: 405,
        exercises: [
    ...
    // Legs 15分
    {
        ...
        totalRestSeconds: 240,
        exercises: [
            { exerciseName: 'ゴブレット・スクワット', sets: 3, reps: 12, recommendedWeight: 20, restSeconds: 60, notes: '深くしゃがむ' },
            { exerciseName: 'カーフレイズ', sets: 2, reps: 20, recommendedWeight: 16, restSeconds: 60, notes: 'つま立ちで静止' },
        ]
    },
    // Legs 30分
    {
